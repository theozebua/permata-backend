                    ...
                    <form action="{{ route('books.update', $book->slug) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" name="title"
                                ...
                                aria-required="true" autocomplete="off" value="{{ old('title', $book->title) }}">
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror resize-none"
                                ...
                                autocomplete="off">{{ old('description', $book->description) }}</textarea>
                            @error('description')
                                <span class="text-danger small">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <img src="{{ $book->image ? '/' . $book->image : 'https://via.placeholder.com/300x300' }}"
                                class="img-fluid rounded w-50" id="preview-image">
                        </div>
                        <div class="form-group">
